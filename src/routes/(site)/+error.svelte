...
<section class="bg-primary">
	<article class="flex min-h-screen min-w-screen justify-center">
		<div class="content-center text-white block only-md:max-w-xl from-lg:max-w-3xl to-md:max-w-fit to-md:mx-4">
